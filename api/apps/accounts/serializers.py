...
class UserRegistrationSerializer(serializers.ModelSerializer):
    ...
    auth_provider = serializers.CharField(
        write_only=True, required=False, default=AUTH_PROVIDERS.get("email")
    )
    ...
    def validate(self, attrs):
        ...
        tc = attrs.get("tc")
        auth_provider = attrs.get("auth_provider", AUTH_PROVIDERS.get("email"))
    ...
    def create(self, validated_data):
        ...
        auth_provider = validated_data.pop("auth_provider", AUTH_PROVIDERS.get("email"))
        ...
        user = User(
            ...
            is_email_verify=auth_provider != AUTH_PROVIDERS.get("email"),
        )
...
class SendPasswordResetEmailSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        link = f"{settings.MAIN_URL_2}/password-reset/{uid}/{token}/"

        # Send email logic
        subject = "Password Reset Request"
        to_email = user.email
        path_to_html = str(settings.BASE_DIR) + "/templates/password_reset.html"
        Util.send_html_email(subject, to_email, path_to_html, {"link": link})
