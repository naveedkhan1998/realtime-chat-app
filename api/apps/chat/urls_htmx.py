...
urlpatterns = [
    ...
    path("app/partials/messages/<int:room_id>/", views.messages_partial, name="messages_partial"),
    path("app/message/<int:message_id>/", views.message_partial, name="message_partial"),
    path("app/message/<int:message_id>/delete/", views.delete_message, name="delete_message"),
    path("app/message/<int:message_id>/read/", views.mark_message_read, name="mark_message_read"),
    path("app/chat/<int:room_id>/send-message/", views.send_message_with_attachment, name="send_message_with_attachment"),
    path("app/partials/shared-media/<int:room_id>/", views.shared_media, name="shared_media"),
    ...
    path("app/partials/friend-requests/", views.friend_requests, name="friend_requests"),
    path("app/search-users-friend/", views.search_users_for_friend, name="search_users_for_friend"),
    path("app/friend-request/send/", views.send_friend_request, name="send_friend_request"),
    path("app/friend-request/<int:request_id>/accept/", views.accept_friend_request, name="accept_friend_request"),
    path("app/friend-request/<int:request_id>/decline/", views.decline_friend_request, name="decline_friend_request"),
    
    # Notifications
    path("app/notifications/", views.notifications_page, name="notifications"),
    path("app/notifications/<int:notification_id>/read/", views.mark_notification_read, name="mark_notification_read"),
    path("app/notifications/read-all/", views.mark_all_notifications_read, name="mark_all_notifications_read"),
