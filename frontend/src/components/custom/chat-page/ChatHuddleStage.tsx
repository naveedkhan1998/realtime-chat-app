...
export default function ChatHuddleStage({
  ...
  if (!isInHuddle) {
    return (
      <div className="px-4 py-2 bg-gradient-to-r from-emerald-500/10 via-background/40 to-emerald-500/5 border-b border-emerald-500/20 backdrop-blur-md">
        <div className="flex items-center justify-between gap-3 max-w-4xl mx-auto">
          <div className="flex items-center gap-3 min-w-0">
            <div className="relative flex items-center justify-center w-8 h-8 rounded-full bg-emerald-500/20 text-emerald-500 flex-shrink-0 animate-pulse">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <Button
              ...
              className="h-8 px-3.5 rounded-xl font-semibold gap-1.5 text-xs bg-emerald-600 hover:bg-emerald-700 text-white shadow-md shadow-emerald-600/20 hover:scale-102 transition-transform"
            >
  ...
  return (
    <>
      <div className="border-b border-emerald-500/20 bg-card/60 backdrop-blur-xl transition-all duration-300">
        <div className="px-4 py-2.5 max-w-5xl mx-auto">
          {/* Header Row */}
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2 min-w-0">
              <div className="flex items-center justify-center w-7 h-7 rounded-lg bg-emerald-500/15 text-emerald-500">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  >
                    {isUsingSfu ? 'Cloudflare SFU' : 'WebRTC P2P Mesh'}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-1.5">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      className="h-7 w-7 rounded-lg hover:bg-muted text-muted-foreground hover:text-emerald-500"
                    >
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      className={cn(
                        'h-7 px-2.5 rounded-lg text-xs font-medium gap-1 transition-all',
                        !isMuted &&
              ...
              <Button
                ...
                className="h-7 px-2.5 rounded-lg text-xs font-medium gap-1 shadow-sm shadow-destructive/20"
              >
                  ...
                  {participants.map(p => {
                    ...
                    return (
                      <div
                        key={p.id}
                        className={cn(
                          'relative flex flex-col items-center justify-center p-2.5 rounded-xl border transition-all duration-200',
                          'bg-background/50 dark:bg-background/40 backdrop-blur-md',
                          isSpeaking
                            ? 'border-emerald-500/60 shadow-md shadow-emerald-500/10 ring-1 ring-emerald-500/40'
                      ...
                      >
                        ...
                        <div className="relative mb-1.5">
                          <Avatar
                            className={cn(
                              'w-11 h-11 border-2 border-background shadow-sm transition-transform duration-200',
                              isSpeaking &&
                          ...
                          {/* Speaking wave icon */}
                          {isSpeaking && (
                            <span className="absolute -top-1 -right-1 bg-emerald-500 text-white p-0.5 rounded-full shadow-sm animate-bounce">
                        ...
                        {/* Name */}
                        <span className="text-xs font-semibold truncate max-w-full text-foreground">
                          {p.name} {isSelf && '(You)'}
                        </span>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <DialogTitle className="text-base font-bold">
                  Huddle Connection & Network Diagnostics
                </DialogTitle>
