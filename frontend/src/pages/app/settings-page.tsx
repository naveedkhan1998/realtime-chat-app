...
export default function SettingsPage() {
  ...
  useEffect(() => {
    localStorage.setItem('notificationSound', String(notificationSound));
  }, [notificationSound]);
        ...
        <section>
          ...
          <div className="p-5 border glass-card rounded-2xl border-border/50">
            <div className="flex items-center gap-4 mb-4">
              <div className="flex items-center justify-center shadow-lg w-14 h-14 bg-gradient-to-br from-primary via-secondary to-accent rounded-2xl shadow-primary/20">
                <MessageCircle className="w-7 h-7 text-white" />
              </div>
              <div>
                <p className="text-lg font-bold text-foreground">Chat App</p>
