...
import { ArrowLeft, Camera, Loader2, User, Mail, Calendar, Shield } from 'lucide-react';
      ...
      <div className="flex-1 max-w-2xl p-6 mx-auto space-y-8">
              ...
              <div className="flex items-center gap-3 px-5 py-3 border bg-muted/30 rounded-xl border-border/30">
                {user?.auth_provider === 'google' ? (
                  <>
                    ...
                    <span className="font-medium text-foreground">Connected with Google</span>
                  </>
                ) : (
                  <>
        ...
        {user?.auth_provider === 'email' && (
          <div className="pt-8 border-t border-border/50">
            <h2 className="mb-6 text-2xl font-bold text-foreground">Change Password</h2>

            <form onSubmit={handlePasswordSubmit(onPasswordSubmit)} className="p-6 space-y-5 border glass-card rounded-3xl border-border/50">
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                {passwordErrors.password2 && (
                  <p className="text-sm text-destructive">{passwordErrors.password2.message}</p>
                )}
              </div>
